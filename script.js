...
// 2. Seleziono il contenitore delle card
const container = document.getElementById("team-container");

// FUNZIONE che genera il codice HTML di una card
...
// 4. Gestisco il form per aggiungere un nuovo membro
const form = document.getElementById("add-member-form");
...
form.addEventListener("submit", function (event) {
  ...
  // uso la funzione per stampare la card
  container.innerHTML += generateMemberCard(newMember);
